...
export function playSound(kind: 'move' | 'blocked' | 'star' | 'goal') {
  ...
  if (kind === 'goal') { tone(523, 0.16, 0.06, when, 'triangle'); tone(659, 0.16, 0.06, when + 0.12, 'triangle'); tone(784, 0.28, 0.07, when + 0.24, 'triangle'); }
}
